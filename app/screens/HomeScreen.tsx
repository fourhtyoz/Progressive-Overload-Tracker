...
export default function HomeScreen({ navigation }: Props) {
    ...
    return (
        <SafeAreaView style={s.wrapper}>
            <View style={s.top}>
                <ImageBackground source={require('@/public/images/cards/result.jpg')} style={s.cardImage}>
                ...
                <View style={s.secondColumn}>
                    <ImageBackground source={require('@/public/images/cards/about.jpg')} style={s.cardImage}>
                        <Pressable style={s.secondBox} onPress={() => navigation.navigate('About')}>
                            <Text style={s.cardTitle}>{t('home.about')}</Text>
                        </Pressable>
                    </ImageBackground>
                    <ImageBackground source={require('@/public/images/cards/settings.jpg')} style={s.cardImage}>
            ...
            <View style={s.bottom}>
                <ImageBackground source={require('@/public/images/cards/history.jpg')} style={s.cardImage}>
